...
import { Button, TextField, Typography, Tabs, Tab } from '@material-ui/core';
...
function LoginForm(props) {
  ...
  const [loginType, setLoginType] = useState(0); // 0 = User, 1 = Theatre Owner
  ...
  return (
    <form className={classes.form}>
      ...
      <Tabs value={loginType} onChange={(e, newValue) => setLoginType(newValue)} centered>
        <Tab label="User Login" />
        <Tab label="Theatre Owner" />
      </Tabs>
      ...
      <Button
        ...
        size="large"
        variant="contained">
        {loginType === 0 ? 'Login as User' : 'Login as Theatre Owner'}
      </Button>
